...
mkdir $CORPUS
[ -e $EXECUTABLE_NAME_BASE-$EXECUTABLE_NAME_EXT ] && ./$EXECUTABLE_NAME_BASE-$EXECUTABLE_NAME_EXT -artifact_prefix=$CORPUS/ -jobs=$JOBS -dict=afl/dictionaries/xml.dict -workers=$JOBS $CORPUS -max_len=64 $LIBFUZZER_FLAGS
