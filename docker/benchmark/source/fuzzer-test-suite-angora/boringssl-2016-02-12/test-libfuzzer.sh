...
mkdir $CORPUS
[ -e $EXECUTABLE_NAME_BASE-$EXECUTABLE_NAME_EXT ] && ./$EXECUTABLE_NAME_BASE-$EXECUTABLE_NAME_EXT -artifact_prefix=$CORPUS/ -use_value_profile=1 -jobs=$JOBS -workers=$JOBS $LIBFUZZER_FLAGS $CORPUS seeds
